...
This is especially problematic if the contexts of each individual are identical, because each individual could think to themselves, "_I_ could avoid working and still receive resources to live".  The issue is, of course, if too many people take this course of action, then the economy will not have enough workers and would collapse.
